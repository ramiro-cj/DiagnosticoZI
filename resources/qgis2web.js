...
map.getView().fit([-11526042.414597, 2340623.821126, -11495911.607967, 2357516.091732], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Diagnóstico de la Zona de Influencia del Centro Com. de Atención a la Salud - Dr. Eduardo Gómez</h2>';
        return titleElement;
    })(),
